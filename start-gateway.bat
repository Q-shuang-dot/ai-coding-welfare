...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "$running = Test-NetConnection -ComputerName 127.0.0.1 -Port 15900 -InformationLevel Quiet -WarningAction SilentlyContinue;" ^
  ...
  "if ($running) { Write-Host '[OK] GCMP 网关运行中 -> http://127.0.0.1:15900' -ForegroundColor Green;" ^
  "  Write-Host '     正在打开管理页面...' -ForegroundColor Gray;" ^
  "  Start-Process 'http://127.0.0.1:15900/admin/' }" ^
